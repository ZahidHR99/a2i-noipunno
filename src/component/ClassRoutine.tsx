                        ...
                        <div className="d-flex justify-content-between align-items-center flex-column flex-md-row">
                            ...
                            <div className="d-flex gap-2 align-items-center">
                                <div className="d-flex gap-2 align-items-center">
                                    ...
                                    <div className={
                                        `${
                                            styles.session_and_all_dropdown
                                        }`
                                    }>
                                        <div className="dropdown">
                                            <button className="dropdown-toggle border-0 bg-white" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                                প্রভাতি সেশন
                                            </button>
                                ...
                                <div className="d-flex gap-2 align-items-center">
                                    ...
                                    <div className={
                                        ...
                                        <div className="dropdown">
                                            <button className="dropdown-toggle border-0 bg-white" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                                                সব
                                            </button>
