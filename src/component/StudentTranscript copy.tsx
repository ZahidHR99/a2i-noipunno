...
export default function StudentTranscript() {
  ...
  // ... other state variables for different dropdowns
  ...
  let pi_selection = pi_data.map((d:any)=>{
    console.log("d", d);
                    ...
                    <div className="col-6 col-sm-4 col-md-3">
                      <div className="mb-3" style={{ fontSize: "12px" }}>
                        ...
                        >
                          ...
                          {Stuent_result?.map((data :any, index) => (
