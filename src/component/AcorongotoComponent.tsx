...
export default function AcorongotoComponent({ assessment_uid, pi_attr, showDetailsshikhonKalinMullayon, Showcollaps, setShowcollaps ,Mullayon_name,shikhonKalinMullayon , setshowDetailsshikhonKalinMullayon}:any ) {
  return (
    <div className="py-5">
                        <h3
